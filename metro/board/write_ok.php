...
if($_POST['SE_NUM1']=='' || $_POST['SE_NUM2']=='' || trim($_POST['SE_NUM1'])+trim($_POST['SE_NUM2'])!=trim($_POST['SE_NUM'])){
		...
		echo "<meta http-equiv='Refresh' content='0;url=/metro/board/list.html/MENU_CODE/$MENU_CODE/now_page/$now_page/GUBN/$GUBN/SEARCH/$SEARCH/BOARD_ID/$BOARD_ID/MODE/list'>";
		exit;
	}
...
if($MODE == "edit"){
	...
	if($i>0){
		...
		echo "<meta http-equiv='Refresh' content='0;url=/metro/board/view.html/MENU_CODE/$MENU_CODE/now_page/$now_page/GUBN/$GUBN/SEARCH/$SEARCH/BOARD_ID/$BOARD_ID/SEQ/$BOARD_SEQ'>";
	}
	else
	{
...
if($MODE == "delete"){
	...
	if($i>0){
		...
		echo "<meta http-equiv='Refresh' content='0;url=/metro/board/list.html/MENU_CODE/$MENU_CODE/BOARD_ID/$BOARD_ID'>";
	}
	else 
	{
		echo "<script type='text/javascript'>alert('DELETE FAIL.');</script>";
		echo "<meta http-equiv='Refresh' content='0;url=/metro/board/list.html/MENU_CODE/$MENU_CODE'>";
	}
exit;
}
...
if($_REQUEST['COMMENT_MODE'] == "write"){
	...
	if($i>0 || $i2>0){
		echo "<script type='text/javascript'>alert('SAVE OK.');</script>";
		echo "<meta http-equiv='Refresh' content='0;url=/metro/board/view.html/MENU_CODE/$MENU_CODE/SEQ/$BOARD_SEQ/now_page/$now_page/GUBN/$GUBN/SEARCH/$SEARCH/BOARD_ID/$BOARD_ID/MODE/view'>";
	}
	else
	{
		echo "<script type='text/javascript'>alert('SAVE FAIL.');</script>";
