...
<?php if($_SESSION['valid_level'] > 3 || $_SESSION['valid_level'] == '') { 
	...
	echo "<meta http-equiv='Refresh' content='0;url=/metro/board/login.html'>";
	exit;
}
?>
<div class="page">
	...
	<div class="grid">
		...
		<div class="content">
			...
			<div class="frames">
				...
				<a href="javascript:imgPop('/metro/erd/model.jpg');"><img src="/metro/erd/model.jpg" title="개체관계도"></a>
				</div>
				<div class="frame" id="_page_2">
				<a href="javascript:imgPop('/metro/erd/model_ko.jpg');"><img src="/metro/erd/model_ko.jpg" title="개체관계도"></a>
				</div>
			</div>
			</div>
		...
		<script>
		        function SnagIt(erd){                 
		                frmExcel.action="/metro/erd/erd_down.php";
