...
if(($_SESSION['valid_level'] >= 3 || is_null($_SESSION['valid_level'])) && $BOARD_ID =='notice' ) {
		...
		echo "<meta http-equiv='Refresh' content='0;url=/_metro/board/list.html/MENU_CODE/$MENU_CODE/BOARD_ID/$BOARD_ID'>";exit;
	}
...
<div class="page-region grid">
	...
	<!--게시판 시작-->
	<div class="span9">
	<form method="post" name="frm" id="frm" action="/_metro/board/write_ok.php" onsubmit="return submitFormWrite(this)" enctype="multipart/form-data" >
	<!-- 테이블 시작 -->
		...
		<div id="board_list_button_table" style="text-align:right">
			<a href="/_metro/board/list.html/MENU_CODE/<?php echo $MENU_CODE?>/now_page/<?php echo $now_page?>/GUBN/<?php echo $GUBN?>/SEARCH/<?php echo $SEARCH?>/BOARD_ID/<?php echo $BOARD_ID?>/MODE/list">
