	...
	<div class="container">
			<div class="row">
				...
				<div class="form-inline mx-auto">
					...
					<form method="get" name="form_search" id="form_search" action="/_fullpage/board/list.php">
				...
				<div class="col-md-12">
							...
							<tbody>
								...
								<div class="listview">
										<div class="list-content">
											<a href="/_fullpage/board/view.php?SEQ=<?php echo $row['SEQ']?>&now_page=<?php echo $now_page?>&GUBN=<?php echo $GUBN?>&SEARCH=<?php echo $SEARCH?>&BOARD_ID=<?php echo $BOARD_ID?>&MODE=view">
					...
					<div class="pagination">
						...
						//================ pageing 출력 10번~12번 code ======================================
								...
								<li class="page-item d-inline-block"><a class="page-link" href="/_fullpage/board/list.php/MENU_CODE/<?php echo $MENU_CODE?>/now_page/<?php echo $before_block?>/GUBN/<?php echo $GUBN?>/SEARCH/<?php echo $SEARCH?>/BOARD_ID=<?php echo $BOARD_ID?>" onFocus="blur()">
								</a></li>
								<?php } ?>&nbsp;
							<?php
								...
								<li class="page-item d-inline-block active"><a class="page-link"><?php echo $i?></a>
									...
									<?php }else{ ?>
								<li class="page-item d-inline-block"><a class="page-link" href="/_fullpage/board/list.php/MENU_CODE/<?php echo $MENU_CODE?>/now_page/<?php echo $i?>/GUBN/<?php echo $GUBN?>/SEARCH/<?php echo $SEARCH?>/BOARD_ID/<?php echo $BOARD_ID?>" onFocus="blur()">
								<?php echo $i?>
								</a></li>		  	
							<?php         }
								}
							...
							<?php
								...
								<li class="page-item d-inline-block"><a class="page-link" href="/_fullpage/board/list.php/MENU_CODE/<?php echo $MENU_CODE?>/now_page/<?php echo $next_block?>/GUBN/<?php echo $GUBN?>/SEARCH/<?php echo $SEARCH?>/BOARD_ID/<?php echo $BOARD_ID?>" onFocus="blur()">
								</a><li>
						<?php }
						//====================================================================
						?>
					...
					<div class="d-none">
						...
						<a href="/_fullpage/board/write.php/MENU_CODE/<?php echo $MENU_CODE?>/now_page/<?php echo $now_page?>/GUBN/<?php echo $GUBN?>/SEARCH/<?php echo $SEARCH?>/BOARD_ID/<?php echo $BOARD_ID?>/MODE/write">
