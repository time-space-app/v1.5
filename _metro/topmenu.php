...
<div class="navigation-bar dark">
    <div class="navigation-bar-content container">
        ...
        <img src="/<?php echo $flugin_url ?>/image/small_logo.png" alt="" style="width:20px;height:20px;vertical-align:middle"/>타임스페이스</a>
	...
	if($result){
		...
		if(is_numeric($row['L_URL']))$row['L_URL']="/$flugin_url/sub.php/CATEGORY/0/MENU_CODE/".$row['L_URL'];
	?>
	<div class="element">
	...
	<?php if($_SESSION['valid_user'] != "") { ?>
		...
		<?php } ?>
        <a title="LogOut" href="/<?php echo $flugin_url ?>/board/logout.php" class="element place-right"><span class="icon-box-add"></span> LogOut</a>
        <span class="element-divider place-right"></span>
        <a title="Mypage" href="/<?php echo $flugin_url ?>/board/join.html" class="element place-right"><span class="icon-star"></span> Mypage</a>
        <?php }else{ ?>
        <a title="Join" href="/<?php echo $flugin_url ?>/board/join.html" class="element place-right"><span class="icon-share-2"></span> Join</a>
        <span class="element-divider place-right"></span>
        <a title="Login" href="/<?php echo $flugin_url ?>/board/login.html" class="element place-right"><span class="icon-github-6"></span>Login</a>
        <?php } ?>
    </div>
</div>