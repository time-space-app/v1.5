...
<div id="board_list_search">
	...
	<select name="GUBN" id="GUBN" class="type-select">
		...
		<option value="4">LOGIN_GUBN</option>
	</select>
...
<div class="board_list_table">
    <table class="list_table">
	   ...
	   <col width="15%" />
		...
		$SQL .= " WHERE";
		$SQL .= " (LOGIN_ID LIKE '%".$SEARCH."%'";
		$SQL .= " OR LOGIN_GUBN LIKE '%".$SEARCH."%'";
		$SQL .= " OR USER_NM LIKE '%".$SEARCH."%')";
		$SQL .= " ORDER BY USER_LEVEL ASC,LOGIN_GUBN ASC,USER_NM ASC LIMIT $st_limit , $recnum_per_page";
