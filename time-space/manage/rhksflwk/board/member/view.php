...
//정보 가져오기 쿼리정리
	$SQL = "SELECT";
	$SQL .= " LOGIN_ID,LOGIN_GUBN,LOGIN_PWD,USER_NM,USER_LEVEL,USE_YN,USER_EMAIL,EMAIL_YN,AGREE_YN,HP_NO,HP_YN";
	$SQL .= " ,PROFILE_TITLE,PROFILE_INFO,PROFILE_EXPERT,VISIT_INFO";
...
<div class="board_write_table">
     <table summary="" class="write_table">
      <caption></caption>
       ...
       <tbody>
        <tr>
		<th>프로필이미지</th>
		<td colspan="3"><img src="/time-space/upload/profile/<?php echo $LOGIN_ID?>.jpg?<?php echo date(YmdHms)?>" width="150px" height="150px"></td>
		<th>레벨</th>
		...
		<th>로그인구분</th>
		<td><?php echo $LOGIN_GUBN?></td>
	</tr>
	<tr>
		<th>약관동의</th>
		<td><?php echo $AGREE_YN?></td>
		<th>이메일</th>
	...
	<tr>
		<th>휴대전화</th>
		<td><?php echo $HP_NO?></td>
		<th>SMS동의</th>
		<td><?php echo $HP_YN?></td>
		<th>로그인허용</th>
	...
	<tr>
		...
		<th>전문분야</th>
		<td><?php echo $PROFILE_EXPERT?></td>
		<th>방문경로</th>
		<td><?php echo $VISIT_INFO?></td>
	</tr>
	<tr>
		<th>자기소개</th>
		<td colspan="5"><?php echo $PROFILE_INFO?></td>
	</tr>
	</tbody>
   </table>
</div>
