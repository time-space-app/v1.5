...
if ( $tree['file_ext'] == 'gif' || $tree['file_ext'] == 'jpg' || $tree['file_ext'] == 'png' || $tree['file_ext'] == 'ico' ) { // images ##
...
} elseif ( $tree['file_ext'] == 'zip' || $tree['file_ext'] == 'tar' || $tree['file_ext'] == 'gzip' || $tree['file_ext'] == 'psd' ) { // tar, gzip, zip ##
...
} elseif ( $tree['file_ext'] == 'txt' || $tree['file_ext'] == 'htaccess' || $tree['file_ext'] == 'ini' || $tree['file_ext'] == 'inc' ) { // txt ##
