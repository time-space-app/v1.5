...
if($_SESSION['valid_level'] == 1){
  //<div class="one" onclick="ecoder_loaded_base();" style="cursor:pointer;background-color:skyblue;">//php5.4 이상에서 에러나서 아래코드로 변경
    echo '
        <div id="load_base">
            <div class="loading">
              <div class="one" onclick="location.replace(\'/time-space/elFinder/elfinder.html\')" style="background-color:yellow;cursor:pointer;">
                    <div class="logo">
