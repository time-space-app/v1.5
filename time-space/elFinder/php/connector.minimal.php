...
$pathLast = explode('/', $_SERVER['DOCUMENT_ROOT']);
$pathHome = array_pop($pathLast);
...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          => '../../../../'.$pathHome.'/',                 // path to files (REQUIRED)
			//'URL'           => dirname($_SERVER['PHP_SELF']) . '/../files/', // URL to files (REQUIRED)
			'URL'           => dirname($_SERVER['DOCUMENT_ROOT']).'/'.$pathHome.'/', // URL to files (REQUIRED)
